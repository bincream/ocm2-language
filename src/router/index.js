...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'version',
        component: () => import('@/views/maintain/version'),
        name: 'version',
        meta: {
          title: '版本信息',
          roles: ['超级管理员']
      ...
      {
        path: 'upgrade',
        component: () => import('@/views/maintain/upgrade'),
        name: 'upgrade',
        meta: {
          title: '设备升级',
          roles: ['超级管理员']
      ...
      {
        path: 'factoryDataReset',
        component: () => import('@/views/maintain/factoryDataReset'),
  ...
  },
  {
    ...
    children: [{
      path: 'sysPer',
      component: () => import('@/views/roleManage/perRole'),
      name: 'PerRole',
      meta: {
        title: 'perRole',
        noCache: true
    ...
    {
      path: 'sysOrg',
      component: () => import('@/views/roleManage/sysOrg'),
      name: 'sysOrg',
      meta: {
        title: 'sysOrg',
        noCache: true
    ...
    {
      path: 'sysLog',
      component: () => import('@/views/roleManage/sysLog'),
      name: 'SysLog',
      meta: {
        title: 'sysLog',
        noCache: true
